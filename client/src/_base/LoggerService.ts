...
import { DebugLevel, Log, LogType } from '@/_base/types'

export { DebugLevel }

export class LoggerService {
  // set the debug logs if VITE_VERBOSE environment variable is present
  static areDebugLogsOn: boolean =
    import.meta.env.VITE_VERBOSE && import.meta.env.VITE_VERBOSE === 'true' ? true : false
  // !!(import.meta.env.VITE_VERBOSE && import.meta.env.VITE_VERBOSE === 'true')
  static logs: Log[] = []
